...
var localization = {
    RU: {
        ...
        codeEmpty: 'Por favor, introduzca el código.',
        codeOk: 'Este código es válido. ¡Gracias por elegir nuestros productos!',
        codeWrong: '¡Por desgracia, este código no puede ser encontrado! Lo más probable es que haya adquirido un producto falsificado.',
        packName: ' шт.',
...
function codeCheck(){
    ...
    $button.on("click", function (ev) {
        ...
        if (codeValues.test(codeValue) && $codeLenght==15){
            return $message.text("Este código es válido. ¡Gracias por elegir nuestros productos!");
        } else if ($code.val() !== '' && $code.val() !== ' ' && $code.val() !== '  '){
            return $message.text("¡Por desgracia, este código no puede ser encontrado! Lo más probable es que haya adquirido un producto falsificado.");
        }else{
            return $message.text("Por favor, introduzca el código.");
        }
});
}
